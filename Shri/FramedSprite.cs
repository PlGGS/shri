...
namespace Shri
{
    public class FramedSprite : Sprite
    {
        ...
        {
            spriteBatch.Draw(_texture, position: _position, sourceRectangle: SourceRectangle, color: _tint, rotation: 0f, scale: _scale, origin: _origin, effects: new SpriteEffects(), layerDepth: 0f);
        }
    }
}
